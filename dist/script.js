...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      phoneInputs = document.querySelectorAll('input[name="user_phone"]'); //в инпут телефона вводить можно только цифры
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(item); //отправляем запрос на сервер
